...
app$setInputs(month = "12")
app$setInputs(year = "2007")
app$click_next()
...
age <- (as.numeric(strsplit(as.character(Sys.Date()), "-")[[1]][1])-2007)*12 +
        as.numeric(strsplit(as.character(Sys.Date()), "-")[[1]][2])-12
